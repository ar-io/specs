...
## Arweave Name System Motivation
...
- **ARNS-TOKEN-01**: Specifies the creation and structure of Arweave Name Tokens, focusing on token functionality and metadata.
- **ARNS-MANAGE-01**: Details the management and control features for Arweave Names, building on the core process specification.
- **ARNS-CORE-01**: The foundational AO process specification for ArNS Name resolution, detailing the core requirements for resolvers.
- **ARNS-RESOLVER-01**: Outlines the protocols for resolving and serving Arweave Names across the AR.IO network.
